...
namespace Movies.Client.Services
{
    public class CRUDService : IIntegrationService
    {
        ...
        //    //Default preference quality is 1 if not set. We can add between 0 and 1.
        //    //Takes JSON as first preference and xml as fall back option.
        ...
        public async Task GetResource()
        {
            ...
            else if (response.Content.Headers.ContentType is {MediaType: "application/xml"})
            {
        ...
        public async Task CreateResource()
        {
            var movieToCreate = new MovieForCreation()
            {
                ...
                Description = "After a simple jewelry heist goes terribly wrong," +
        ...
        public async Task UpdateResource()
        {
            ...
            var seriaizedMovieToUpdate = JsonSerializer.Serialize(movieToUpdate);

            var request = new HttpRequestMessage(HttpMethod.Put,
                "api/movies/5b1c2b4d-48c7-402a-80c3-cc796ad49c6b");
            request.Headers.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));

            request.Content = new StringContent(seriaizedMovieToUpdate);
            request.Content.Headers.ContentType = new MediaTypeHeaderValue("application/json");
        ...
        #region Shortcuts
        //When using shortcuts, the Accept header is not automatically set or not set.
        //For Restful systems, it is obligatory to set Accept header.
        //To set the Accept header or other headers on a per-request basis, the way to go is not to use shortcuts.
        //For full control, use HTTP Request Message.
        ...
        private async Task PutResourceShortcut()
        {
            ...
            var response = await _httpClient.PutAsync("api/movies",
                new StringContent(
